...
maximum_number_of_credits = 0
number_of_semesters = 0
passed_grades = []
hours_by_semester = {1: 15, 2: 16, 3: 3}
...
def menu():
    ...
    print("1) Print the student Study Plan.")
    print("2) Enter the name and location of the Student Records file.")
    print("3) Print the student Study Plan that showing the passed courses.")
    print("4) Input your preferences.")
    print("5) Enter the number of semesters that you want to do schedule planning for.")
    print("6) Print the suggested courses' schedule.")
    print("7) Save the schedules to a text file.\n")
...
def priority(courses, current_hours, passed_grades, courses_by_year_and_semester, my_semester, making_semester, semester_number):
